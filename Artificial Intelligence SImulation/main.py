...
plt.xlabel("Years")
plt.ylabel("Floating Point Operations per Second")
plt.title("FLOPS of Supercomputers from 1993-2021")
plt.plot(ye,fl)
...
plt.xlabel("Years")
plt.ylabel("Log Base 10 of FLOPS")
plt.title("Log Base 10 of FLOPS of Supercomputers from 1993-2021")
...
plt.xlabel("Years")
plt.ylabel("Log Base 10 of FLOPS of Supercomputers")
plt.title("Predictions on FLOPS using Linear Regression")
...
plt.plot(x,y)
plt.xlabel("Time")
plt.ylabel("HPL-AI readings (Eflop/s)")
plt.title("Readings based on HPL-AI benchmark 2019-2021")
